            ...
            <Layout>
                    ...
                    <div className="container">
                      <div className="grid-wrapper">
                        ...
                        <div className="col-8 align-left">
                          <h6 class="content__label--white">Our Mission</h6>
                          <h1 className="hero__headline--white">Bringin' the chain at enterprise scale.</h1>
                        </div>
                        <div className="col-2"></div>
                      </div>
                    </div>
              ...
              <section className="--content--padding">
                <div className="container">
                  <div className="grid-wrapper">
                    <div className="col-6">
                      <h6 class="content__label--dark"><img src={iconCube} alt="Topaz" className="features__image--icon-small" />How Topaz Works</h6>
              ...
              <section className="">
                <div className="container">
                  <div className="grid-wrapper">
                    ...
                    <div className="col-12">
                      <h6 class="content__label--dark"><img src={iconCube} alt="Topaz" className="features__image--icon-small" />The Future of Finance</h6>
